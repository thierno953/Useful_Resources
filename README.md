...
- [Azure Sentinel Notebooks](https://github.com/Azure/Azure-Sentinel-Notebooks/tree/master)
- [List of M365 Operations](https://learn.microsoft.com/en-us/purview/audit-mailboxes)
...
- [tcpdump Exemples - 50 ways to isolate traffic for cybersecurity](https://danielmiessler.com/blog/tcpdump)
...
- [Cloud Incidents](https://threats.wiz.io/all-incidents)
- [Certificates](https://www.rfc-editor.org/rfc/rfc5280#section-4.1.2.6)
- [Cheat Sheets - Malware Archaeology](https://www.malwarearchaeology.com/cheat-sheets)
- [Common Registry Persistence](https://blog.qualys.com/product-tech/2021/05/25/windows-registry-integrity-monitoring-with-qualys-fim)
...
- [JA4T](https://medium.com/foxio/ja4t-tcp-fingerprinting-12fb7ce9cb5a)
- [JA4 Github](https://github.com/FoxIO-LLC/ja4/tree/main)
- [MITRE ATT&CK](https://attack.mitre.org/)
- [JavaScript:Splunk Cheat Sheet](https://www.splunk.com/en_us/blog/learn/splunk-cheat-sheet-query-spl-regex-commands.html)
- [TCPIP](https://www.garykessler.net/library/tcpip_prg_GKA.pdf)
